...
test_df.to_csv("test_patients_v2_locked.csv", index=False)
...
def train():
    ...
    for epoch in range(EPOCHS):
        ...
        if avg_val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), "resnet50_v2_best.pth")

    print("Training Complete. Model saved to resnet50_v2_best.pth")
